...
app.post('/webhook', (req, res) =>{
    ...
    if (body.object === 'page') {
        ...
        body.entry.forEach(function(entry) {
            ...
            // Check if webhook event is a message or postback and pass the event to the appropriate handler function
        ...
        // Returns a '404 Not Found' if event is not from a page subscirption
        res.sendStatus(404);
    }
